...
class BF{
    ...
    constructor(buckets, splits,customHashFn = null){
        ...
        for (let x = 0; x < this._splitSize; x++){
            let internalArray = new Array(this._bucketSize);
    ...
    get FalsePositiveRate(){
        let internal_iter;
        let collision_prob = 1/this._bucketSize;
        let non_collision = 1 - collision_prob;
        let non_collision_splits = 1,non_collision_all = 1;
        let fpr = 1;
